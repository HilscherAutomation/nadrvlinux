...
*****************************************************************************************
    ...
    Filename:
     $Id: netx_registers.h 5432 2013-07-01 07:20:14Z sebastiand $
    Last Modification:
     $Author: sebastiand $
...
#define NETX_DPM_NOMEMORY_ASSIGNED    0x0BAD0BAD
#define NETX_DPM_INVALID_CONTENT      0xFFFFFFFF
...
typedef struct NETX_DMA_CHANNEL_CONFIGtag
{
  ...
  volatile uint32_t ulMemBaseBuffer3;    /*!< Base Address of Buffer 3                                             */
  volatile uint32_t ulMemBaseBuffer2;    /*!< Base Address of Buffer 2                                             */
  volatile uint32_t ulMemBaseBuffer1;    /*!< Base Address of Buffer 1                                             */
